...
public class Application {
   ...
   super()는 부모클래스가 가지는 private 생성자를 제외한 나머지 생성자를 호출할 수 있는 구문이다
     */
        ...
        Product product2 = new Product("S-01234", "t삼성","갤럭시폴드",2398000, new java.util.Date());
        System.out.println(product2.getInformation());

        Computer computer1 = new Computer();
        System.out.println(computer1.getInformation());

        Computer computer2 = new Computer("튋텀 스냅드래곤", 512,12,"안드로이드");
        System.out.println(computer2.getInformation());

        Computer computer3 = new Computer("S-01234", "삼성", "갤럭시폴드",239800,
                new java.util.Date(), "퀼컴 스냅드래고", 512,12,"안드로이드");
